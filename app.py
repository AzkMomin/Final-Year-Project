...
# Load a second sample picture and learn how to recognize it.
Arham_image = face_recognition.load_image_file("Arham/Arham.jpg")
Arham_face_encoding = face_recognition.face_encodings(Arham_image)[0]

# Load a second sample picture and learn how to recognize it.
Ali_image = face_recognition.load_image_file("Ali/Ali.jpeg")
